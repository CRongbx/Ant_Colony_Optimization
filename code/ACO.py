...
pheromone_graph = [[1.0 for col in range(CityCount)] for raw in range(CityCount)]
...
class Ant(object):
    ...
    def __clean_data(self):
        ...
        self.open_table_city = [True for i in range(CityCount)]     # 地图中所有城市的探索状态

        city_index = random.randint(0,CityCount-1)  # 随机初始化城市（从0开始编号）
    ...
    def __choice_next_city(self):
        ...
        # 若无法从转盘概率选出，随机选择一个城市
        if next_city == -1:
            next_city = random.randint(0,CityCount-1)
            # 若该城市已经走过，则再随机选一遍
